...
class SearchBarController extends Controller
{
	...
	public function jsonResults($keyword){
		...
		foreach($results as $index => $subarray)
			$result.= "<a href=".Yii::app()->baseUrl."/index.php"."/".$index." style='text-decoration:none;'><div class='resultbars' style='border-bottom:1px solid white;padding:5px;cursor:pointer;'> <h5>".$subarray["title"]."</h5>".$subarray["desc"]."</div></a>";
