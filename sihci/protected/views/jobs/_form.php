...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'start_day',array('placeholder'=>'Día de Inicio')); ?>
		<?php echo $form->error($model,'start_day'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'start_month'); ?>
		<?php echo $form->textField($model,'start_month',array('placeholder'=>'Mes de Inicio')); ?>
		<?php echo $form->error($model,'start_month'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'start_year'); ?>
		<?php echo $form->textField($model,'start_year',array('placeholder'=>'Año de Inicio')); ?>
	...
	<div class="row buttons">
		...
		<?php echo CHtml::resetButton($model->isNewRecord ? 'Borrar' : 'Guardar'); ?>
	</div>
