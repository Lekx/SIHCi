...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('delegation')); ?>:</b>
	<?php echo CHtml::encode($data->delegation); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('external_number')); ?>:</b>
