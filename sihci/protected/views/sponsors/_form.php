...
6244 	GUARDERIAS -->
	...
	<div class="row">
		...
		<?php echo $form->fileField($modelPersons, 'photo_url', array('id'=>'photo_url' ,'size' => 60, 'maxlength' => 100, 'placeholder' => "Foto"));?>
	...
	<div class="row buttons">
		...
		<?php echo CHtml::link('Cancelar', array('/sponsors/SponsorsInfo'),array('confirm' => 'Si cancela todo los datos escritos se borraran. ¿Está seguro de que desea cancelar?')); ?>
	</div>
