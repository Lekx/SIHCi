...
<div class="grafiOpt">
  ...
  <div class="col-md-4">¿Perteneciente al SNI?</div>
  <div class="col-md-4">Tipo de Reporte</div>
</div>
<div class="grafiOpt">
  <div class="col-md-4">
  ...
  <?php echo CHtml::dropDownList('sni', '',array("total"=>"Ambos","no"=>"No","yes"=>"Si"),array('onchange'=>'loadChart()','class'=>'dropinline')); ?>
    ...
    <div class="col-md-4">
        <span class="plain-select2">
  <?php echo CHtml::dropDownList('type', '',array("total"=>"Total registrados","bajas"=>"Bajas","altas"=>"Altas"),array('onchange'=>'loadChart()','class'=>'dropinline')); ?>
    </span>
  </div>
</div>
...
chart = new Highcharts.Chart({
      ...
      enabled: false
        ...
        title: {
            text: 'Investigadores registrados en el sistema'+ '<br>' + 'Total:' + ' ' + ($("#years").val() == 'total' ? data.totalUsers : $("#years").val() != 'total' ? totals = total() : '')
        },
