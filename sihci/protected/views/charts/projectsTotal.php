...
chart = new Highcharts.Chart({
      ...
      enabled: false
        ...
        title: {
            text: 'Proyectos registrados en el sistema' + '<br>'+ 'Total:'+ ' ' +($("#years").val() == 'total' ? data.totalUsers : $("#years").val() != 'total' ? totals = total() : ''),
        },
        subtitle: {
       ...
       tooltip: {
        ...
        series: [{
            ...
            name: 'No asignados'+ '<br>' + 'Total:' + '' + ($("#years").val() == 'total' ? data.other : $("#years").val() != 'total' ? other = totalOther() : ''),
            data: data.other
